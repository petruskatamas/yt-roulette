...
export const hu: Messages = {
  ...
  join: {
    noLan: 'Nem található hálózati cím — a gép ugyanazon a Wi-Fi-n legyen, mint a telefonok.',
    scanHint: 'Olvasd be a telefonoddal → írd meg a saját bingókártyád. A pipa a leadott kártyát jelöli.',
  },

  host: {
    serverDown: 'A szerver nem elérhető — fut az `npm run dev`?',
    offline: 'megszakadt a kapcsolat a játékszerverrel…',
    connect: 'Csatlakozás',
    newGame: 'Új játék',
    players: 'Játékosok',
    ...
    writingCard: 'kártyát ír…',
    bingo: 'BINGÓ',
    cardOf: (name: string) => `${name} kártyája`,
    stillWriting: 'Még írja a kártyáját…',
  },
